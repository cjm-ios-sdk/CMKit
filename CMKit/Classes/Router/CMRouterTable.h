...
//
//  pageId为主键，如：
//  @{@"10000":@{@"page_class":@"CMMainViewController", @"page_name":@"首页"}，
//    @"10001":@{@"page_class":@"CMLoginViewController", @"page_name":@"登录页"}}
//
//  pageClass为主键，如：
//  @{@"CMMainViewController":@{@"page_class":@"10000", @"page_name":@"首页"}，
//    @"CMLoginViewController":@{@"page_class":@"10001", @"page_name":@"登录页"}}
//
...
#define CMRouterPageId         @"page_id"      // 页面id
#define CMRouterPageClass      @"page_class"   // 页面类名
#define CMRouterPageName       @"page_name"    // 页面名称


@interface CMRouterTable : NSObject
